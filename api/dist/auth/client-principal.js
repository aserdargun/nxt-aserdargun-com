...
const PRINCIPAL_KEYS = ["identityProvider", "userDetails", "userRoles", "userId"];
...
export const decodeClientPrincipal = (header) => {
    if (header === null) {
        return null;
    }
    ...
    const principal = Object.create(null);
...
const isPrincipal = (value) => {
    ...
    return (isBoundedNonBlankString(value.identityProvider, MAX_PROVIDER_LENGTH) &&
        ...
        value.userRoles.every((role) => isBoundedNonBlankString(role, MAX_ROLE_LENGTH)));
};
const isPlainRecord = (value) => typeof value === "object" && value !== null && Object.getPrototypeOf(value) === Object.prototype;
const isBoundedNonBlankString = (value, maximum) => typeof value === "string" && value.length <= maximum && value.trim().length > 0;
//# sourceMappingURL=client-principal.js.map
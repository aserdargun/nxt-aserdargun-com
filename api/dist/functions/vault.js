...
const parseVaultPage = (request, dependencies) => {
    ...
    if (cursor === null)
        return { entryOffset: 0, folderOffset: 0, limit, generation: null };
    ...
    if (!Number.isSafeInteger(generation) || !Number.isSafeInteger(entryOffset) || !Number.isSafeInteger(folderOffset) || entryOffset < 0 || folderOffset < 0)
        throw new ApiResponseError("INVALID_INPUT");

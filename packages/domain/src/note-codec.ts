import { NoteDocumentSchema, type NoteDocument } from "@nxt/contracts";
...
export function parseNote(source: string): NoteDocument {
...
export function serializeNote(note: NoteDocument): string {
